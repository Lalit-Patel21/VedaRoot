export default {
  ...
  UPDATE_PRODUCT_QTY: "http://localhost:5000/api/cart/update",
  ...
  LOAD_HOMEREMEDY: "http://localhost:5000/api/homeRemedy",
  Homeremedy_BY_ID: "http://localhost:5000/api/homeRemedy",
  ...
  FORGATE_PASSWORD: "http://localhost:5000/api/user/forgotPassword",
